...
(function( $ ){
	var methods = {
        ...
        getXML : function(){
            return $(this).data('xml2html').dataArray;
        },
                ...
                $.ajax({
                    ...
                    success: function(jsonData){
                        ...
                        for (var i=0, len= jsonData.cols.length; i <len; i++) {
                            _tagNames[i] = jsonData.cols[i];
                            _indexCols[_tagNames[i]] = i;
                        }
	 ...
	 function _calcResultPages(){
			var totalPages = Math.floor(
                ...
                this.data('xml2html').resultsPerPage);
	...
	function _loopXML(){
        ...
        var dataArray = $(this).data('xml2html').dataArray; 
		...
		for (var i=startIndex; (i<xmlSize && i<nextSet); i++){
			...
			for (var j=0; j<_tagNames.length; j++){
				...
				var xmlValue = row[_indexCols[_tagNames[j]]];
			console.log(i+" "+_tagNames[j]);
